...
public class ExternalNewsFetchService {
    ...
    private UriComponentsBuilder buildUriComponentsForTopHeadlines(String baseUrl, String endpoint, TopHeadlineRequestDto requestDto) {
    ...
    public NewsResponseDto getTopHeadLines(TopHeadlineRequestDto requestDto) {
        ...
        UriComponentsBuilder uriBuilder = buildUriComponentsForTopHeadlines(baseUrl, endpoint, requestDto);
        ...
        private UriComponentsBuilder buildUriComponentsForAllNews(String baseUrl, String endpoint, AllNewsRequestDto requestDto) {
        UriComponentsBuilder uriComponentsBuilder = UriComponentsBuilder
        .fromUriString(baseUrl)
        .pathSegment(endpoint);
    ...
    public NewsResponseDto getAllNews(AllNewsRequestDto requestDto) {

        String baseUrl = newsClientApiConfig.baseUrl();
        String endpoint = newsClientApiConfig.endpoint().get("everything");
        UriComponentsBuilder uriBuilder = buildUriComponentsForAllNews(baseUrl, endpoint, requestDto);
